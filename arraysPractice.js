...
function finder(numArray) {
    for (var i = 0; i < numArray.length; i++) {
        if (numArray[i] === getRandomArbitrary()) {
            return true;
        };
    }
    return false;
...
function addTen(numbers) {
    ...
    for (var i = 0; i < numbers.length; i++) {
        var newNum = Number(numbers[i]) + 10;
        numsPlusTen.push(newNum);
    }
    return numsPlusTen;
}
...
var user2 = {
    name: 'Brandon Smith',
    email: 'llcoolb@gmail.com',
    password: 'mamasaidknockyouout',
    username: 'comebackkid'
};

var user3 = {
    name: 'Flavor Flave',
    email: 'goldclockking@gmail.com',
    password: 'flavoroflove',
    username: 'planetRock'
};
...
//Code Here
function findAndDeleteTyler(users) {
